...
;(load-file "~/.emacs.d/solarized-emacs/solarized-dark-theme.el")
;;(if window-system
;;    (color-theme-cobalt))
;;3
;(;add-to-list 'load-path "~/.emacs.d/emacs-purple-haze-theme/")
;(load-file "~/.emacs.d/emacs-purple-haze-theme/purple-haze-theme.el")
;;(if window-system
 ;;   (color-theme-cobalt))

;;4
;(add-to-list 'load-path "~/.emacs.d/theme/")
;(load-file "~/.emacs.d/theme/deep-blue-day-theme.el")
;(if window-system
 ;   (color-theme-cobalt))

;5
;(add-to-list 'load-path "~/.emacs.d/theme/")
;(load-file "~/.emacs.d/theme/mechanical-turq-theme.el")
;(if window-system
 ;   (color-theme-cobalt))

;;6
;(add-to-list 'load-path "~/.emacs.d/theme/")
;(load-file "~/.emacs.d/theme/tangerine-theme.el")
;(if window-system
;    (color-theme-cobalt))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Enable method autocompletion

(add-to-list 'load-path "/home/amritendu/.emacs.d")
